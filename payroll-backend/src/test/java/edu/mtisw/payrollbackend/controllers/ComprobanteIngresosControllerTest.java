...
import edu.mtisw.payrollbackend.controllers.ComprobanteIngresosController;
...
@WebMvcTest(ComprobanteIngresosController.class)
public class ComprobanteIngresosControllerTest {
